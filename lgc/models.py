...
INVOICE_STATE_COMMON_CHOICES = (
    (INVOICE_STATE_PENDING, _('Pending')),
    (INVOICE_STATE_CANCELED, _('Canceled')),
)
INVOICE_STATE_ONLY_CHOICES = (
    (INVOICE_STATE_TOBEDONE, _('To be done')),
    (INVOICE_STATE_DONE, _('Done')),
    (INVOICE_STATE_PAID, _('Paid')),
)

QUOTATION_STATE_ONLY_CHOICES = (
    (INVOICE_STATE_QUOTATION_SEEN, _('Seen')),
)
INVOICE_STATE_CHOICES = INVOICE_STATE_COMMON_CHOICES + INVOICE_STATE_ONLY_CHOICES
QUOTATION_STATE_CHOICES = INVOICE_STATE_COMMON_CHOICES + QUOTATION_STATE_ONLY_CHOICES

INVOICE_ALL_CHOICES = INVOICE_STATE_COMMON_CHOICES + INVOICE_STATE_ONLY_CHOICES + QUOTATION_STATE_ONLY_CHOICES
